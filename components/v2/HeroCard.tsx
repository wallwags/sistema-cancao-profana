...
export default function HeroCard() {
  return (
    <div
      className="fade-up-800 relative overflow-hidden rounded-[32px] p-6 sm:p-10 md:p-14 border-2 border-[#F0C265]/30 hover:border-[#F0C265]/50 bg-gradient-to-b from-[#0B1220] via-[#060A14] to-[#03050A] backdrop-blur-2xl shadow-[0_0_60px_rgba(240,194,101,0.12),inset_0_1px_1px_rgba(255,255,255,0.1)] flex flex-col justify-between items-center text-center space-y-6 transition-[border-color] duration-500 group"
    >
