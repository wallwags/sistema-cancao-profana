...
export default function GlobalCta({
  ...
  return (
    <button
      ...
      className={`w-full sm:w-auto sm:min-w-[300px] px-10 py-3.5 rounded-full ${invisible ? 'invisible' : ''} text-xs sm:text-sm uppercase tracking-widest font-black text-center outline-none focus-visible:ring-2 focus-visible:ring-[#F0C265]/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#05070B] active:scale-[0.98] transition-all ${
        waitlistMode
